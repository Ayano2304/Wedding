    ...
    <div>
      <section className="story" id="story">
        ...
        <Container>
          ...
          <Row data-aos="fade-left" data-aos-duration="1000" className="justify-content-center row-story mb-5">
          ...
          <Row data-aos="fade-right" data-aos-duration="1000" className="justify-content-center row-story mb-5">
            <Col className="text-center data-2">
